...
$max_input_var_limit = ini_get("max_input_vars");
$no_of_input_var = $_POST['no_of_vars'];

if($max_input_var_limit > $no_of_input_var){
		...
		if(isset($_POST['action']) && !empty($_POST['action'])){
			...
			if(
				...
				if($fields_data['result']){
					...
					//$return['fetch_record'] = $last_record;
	...
	$return['info'] .= "<b>memory limit reached </br>current memory stack: $max_input_var_limit </br>required memory stack: $no_of_input_var </b>";
}
