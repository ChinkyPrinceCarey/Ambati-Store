...
$(function(){
    ...
    dropdown_sale_type = $('.ui.selection.dropdown.sale-type');
    ...
    dropdown_reports_type
        ...
        .dropdown({ onChange: saleTypeOnChange});
    ...
    default_datatable_options = {
        ...
        "ajax": {
            ...
            "data": function(d){
                ...
                d.sale_type = dropdown_sale_type.dropdown('get value');
...
function saleTypeOnChange(value){
    let reports_type = dropdown_reports_type.dropdown('get value');
    console.log(`reports_type: ${reports_type}`);
    setTable(reports_type);
}
